...
function TripSearch() {
  ...
  return (
    <div className='container mx-auto p-5 bg bg-search-background bg-cover bg-center bg-no-repeat lg:py-28'>
      ...
      <div className='flex flex-col gap-5 mt-5 mb-5 lg:flex-row lg:bg-primary lg:bg-opacity-25 lg:max-w-[950px] lg:mx-auto lg:p-4 lg:rounded-lg lg:mt-10'>
        <Input 
        ...
        <div className='flex gap-4 lg:w-full'>
          <Controller
            ...
            control={control}
            render={({field})=>(
              <DatePicker className='w-full'  placeholderText='Data final' onChange={field.onChange} selected={field.value} minDate={new Date()}/>
            )}
